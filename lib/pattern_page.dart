...
class PatternLock2 extends StatefulWidget {
  ...
  /// Creates [PatternLock2] with given params.
  const PatternLock2({
    Key? key,
    this.dimension = 3,
    ...
    this.used = const [2,3,4],
    required this.onInputComplete,
  }) : super(key: key);

  @override
  _PatternLock2State createState() => _PatternLock2State();
}

class _PatternLock2State extends State<PatternLock2> {
  List<int> used = [];
  Offset? currentPoint;
