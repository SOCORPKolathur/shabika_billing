...
const List<String> list1 = <String>['Numbers(NOS)', '2', '3', '5'];
                      ...
                      children: [
                        ...
                        StreamBuilder<QuerySnapshot>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            if(isserach==true&&snapshot.data!.docs[index]["categoryname"].toString().toLowerCase().contains(Username.toLowerCase())){
                              return
                                Row(
                                  children: [
                                ...
                                else if(isserach==false&&snapshot.data!.docs[index]["categoryname"].toString().toLowerCase().contains(Username.toLowerCase())){
                                  return
                                    Row(
                                      children: [
...
//delete function
  delete(catid){
    FirebaseFirestore.instance.collection("category").doc(catid).delete();
  ...
  ediditemsetfunction(docid)async{
    ...
    setState(() {
      edititem.text=value!['categoryname'];
    });
  }
