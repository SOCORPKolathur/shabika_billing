...
class _Payment_PageState extends State<Payment_Page> {
                ...
                children: [
                  ...
                  StreamBuilder<QuerySnapshot>(
                    stream: FirebaseFirestore.instance
                        .collection("PaymentTypes").orderBy("timestamp",descending: true)
                        .snapshots(),
  ...
  Brand() {
    FirebaseFirestore.instance.collection("PaymentTypes").doc().set({
      "Paymentname":Brandname.text,
...
//delete function
  delete(barndid) {
    FirebaseFirestore.instance.collection("PaymentTypes").doc(barndid).delete();
  }
  ...
  edidtheitemfunction(docid){
    FirebaseFirestore.instance.collection("PaymentTypes").doc(docid).update({
      "Paymentname":edititem.text,
    });
  }
  ediditemsetfunction(docid)async{
    var getdatae=await FirebaseFirestore.instance.collection("PaymentTypes").doc(docid).get();
    Map<String,dynamic>?value=getdatae.data();
    setState(() {
      edititem.text=value!['Paymentname'];
    });
  }
