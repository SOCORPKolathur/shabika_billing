...
class _SigninpageState extends State<Signinpage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: Color(0xff01A99E),
      body: Column(
        children: [
          Stack(
            children: [
                  ...
                  Padding(
                    ...
                    child: Text("Welcome Admin",
                        style: GoogleFonts.poppins(
                            fontSize: 29, color: Color(0xffFFFFFF))),
                  ),
                  Padding(
                    padding: const EdgeInsets.only(bottom: 18, right: 149),
                    child: Text("Shabika Billing",
                        style: GoogleFonts.poppins(
                            fontSize: width/68.3, color: Color(0xffFFFFFF))),
                  ),
                  Padding(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: GestureDetector(onTap: () {
                        ...
                        child: Container(child: Center(child: Text("Sign in",style: GoogleFonts.poppins(color: Colors.white),)),
                          width: width/7.5,
                          height: height/13.14,
                          // color: Colors.teal,
                          decoration: BoxDecoration(color: Color(0xff00A99D),borderRadius: BorderRadius.circular(12)),
